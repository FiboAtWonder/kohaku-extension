...
window.addEventListener('eip6963:requestProvider', () => {
  // Dispatched on `window`, so another injected script asking others to announce could
  // trigger this too. Same caller-stack check as `isDapp` below: trust it only if it
